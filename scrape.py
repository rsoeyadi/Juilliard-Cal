...
for eventGroupUL in eventGroupsULs:
        ...
        for eventGroup in eventGroups:
                ...
                month = eventGroup.find_element_by_class_name("month")
                day = eventGroup.find_element_by_class_name("day")
                ...
                for event in events:
                    ...
                    location = article.find_element_by_class_name("field--name-field-venue")
                    time = article.find_element_by_tag_name("time")
